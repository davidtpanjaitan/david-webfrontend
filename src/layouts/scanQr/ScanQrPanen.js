...
function ScanQrPanen() {
    ...
    const handleScan = useCallback((data) => {
      if (data) {
          ...
          if (user.role === "admin"){
            navigate(`/panen/${data.text}`)
          } else if (user.role === "petugasLokasi"){
            navigate(`/panen/${data.text}/isi-data`)
          } else if (user.role === "picLokasi"){
            navigate(`/panen/${data.text}/konfirmasi-lapangan`)
          } else if (user.role === "petugasWarehouse"){
            navigate(`/panen/${data.text}/konfirmasi-warehouse`)
          }
  ...
  const handleError = useCallback((err) => {
    ...
    //       navigate(`/panen/${decodedText}/isi-data`);
